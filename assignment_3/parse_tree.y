...
%token INT FLOAT DOUBLE CHAR COMMA SEMICOLON EQUAL BRACKET_OPEN BRACKET_CLOSE PLUS MONUS DIV MULT 
%token <strval>ID
%token <numval>NUMBER
...
ARITHMETIC_EXPRESSION:	ARITHMETIC_EXPRESSION PLUS {push("+");} TERM	{codegen();}
