...
WHILELOOP: WHILE {w_index++; } BRACKET_OPEN ARITHMETIC_EXPRESSION BRACKET_CLOSE {printf("W%d0:\t", w_index);printf("IF t%d goto W%d1\ngoto W%d2\nW%d1:", tint-1, w_index, w_index, w_index);} CURLY_OPEN IN_BRACES CURLY_CLOSE {printf("goto W%d0\nW%d2:\n", w_index, w_index); w_index--;} 	
	   ;	
